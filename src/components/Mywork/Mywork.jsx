...
const Mywork = () => {
  ...
  return (
    <div className='mywork' id='work'>
          ...
          return (
            <div key={index} className="work-item" onClick={() => openModal(work)}>
              ...
              <div className="work-overlay">
                ...
                <span className={`work-status ${work.w_status}`}>
      ...
      {/* Lightbox pour les images en taille réelle */}
      {selectedImage && (
        <div className="lightbox-overlay" onClick={closeLightbox}>
          <div className="lightbox-content" onClick={(e) => e.stopPropagation()}>
            ...
            {selectedWork?.w_images && (
              <div className="lightbox-counter">
                {selectedWork.w_images.indexOf(selectedImage) + 1} / {selectedWork.w_images.length}
              </div>
            )}
          </div>
        </div>
